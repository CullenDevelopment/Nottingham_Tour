...
public class TourAdapter extends ArrayAdapter<Tour> {
    ...
    private int mColorResourceId; //stores the color id for the current category
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView venueNameView = (TextView) convertView.findViewById(R.id.venue_name_view);
        // Get the version name from the current Tour object and
        // set this text on the name TextView
        venueNameView.setText(currentTour.getVenueName());

        // Find the TextView in the list_item.xml layout with the ID version_number
        TextView venueAddressView = (TextView) convertView.findViewById(R.id.venue_address_view);
        ...
        // Find the TextView in the list_item.xml layout with the ID version_number
        TextView venueTelephoneView = (TextView) convertView.findViewById(R.id.venue_telephone_view);
        // Get the version number from the current Tour object and
